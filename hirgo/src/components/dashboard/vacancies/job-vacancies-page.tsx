...
import { useGetAllCategoriesQuery, useGetCategoryByIdQuery } from "@/app/features/category/categoryApi";
...
function CategoryFetcher({ 
  ...
  const { category, isLoading, error } = useCategoryById(categoryId);
...
export default function JobVacanciesPage() {
  ...
  }, [filterVacancies, pageSize, allCategories, currentPage, totalPages, totalItems]);
