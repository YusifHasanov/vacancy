        ...
        >
          ...
          <div className="w-full md:w-2/5 lg:w-1/3">
            <div className="bg-background rounded-lg border h-[calc(100vh-140px)] flex flex-col">
              ...
              <ScrollArea className="flex-grow overflow-auto h-full scroll-container" style={{ position: "relative" }}>
                        ...
                        return (
                          <div ref={lastVacancyElementRef} key={job.id}>
                            <JobListItem
                              ...
                              onToggleFavorite={() => {}} // Empty function since we don't need favorites
                            />
                          </div>
                        )
                      } else {
          ...
          <DrawerContent className="max-h-[90vh]">
            <DrawerHeader className="border-b">
              <div className="flex items-center justify-between">
                <Button variant="ghost" size="icon" onClick={() => setIsDrawerOpen(false)} className="absolute left-2">
